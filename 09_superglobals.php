<?php
/*------------------------Superglobals----------------------------*/
//These are a set of functions in PHP that are resposible for particular functionalities
//Superglobals in PHP are important and are used in various places especially in backend development

/*
**PHP superglobals include the following
...
// var_dump($_SERVER);
//We can get ingformation about our server environment using the following
?>
...
<head>
    ...
    <title>Local Host Server Information</title>
</head>
<body>
    <ul>
